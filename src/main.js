...
function addToFavorites(palette) {
    const container = document.getElementById('favoritesBoxesContainer');
    const paletteContainer = document.createElement('div');
    paletteContainer.className = 'favoritesPaletteContainer';
                                ...
                                <g>
                                    <g>
                                        ...
                                        <g>
                                            <path
                                                style="fill: #5d5d5d"
                                                d="M96.597,198.41l30.327-0.958c5.168-0.163,9.47,4.138,9.573,9.573l4.59,242.725 c0.101,5.357-3.92,9.8-9.015,9.961l-30.327,0.958c-5.169,0.163-9.47-4.138-9.573-9.573l-4.59-242.725 C87.481,203.014,91.502,198.571,96.597,198.41z"
                                            ></path>
                                            <path
                                                style="fill: #5d5d5d"
                                                d="M332.993,198.41l-30.327-0.958c-5.169-0.163-9.47,4.138-9.573,9.573l-4.59,242.725 c-0.101,5.357,3.92,9.8,9.015,9.961l30.327,0.958c5.169,0.163,9.47-4.138,9.573-9.573l4.59-242.725 C342.109,203.014,338.088,198.571,332.993,198.41z"
                                            ></path>
                                            <path
                                                style="fill: #5d5d5d"
                                                d="M230.476,197.889h-30.711c-5.03,0-9.108,4.078-9.108,9.107v244.128 c0,5.029,4.078,9.107,9.108,9.107h30.711c5.03,0,9.108-4.078,9.108-9.107V206.996 C239.584,201.967,235.506,197.889,230.476,197.889z"
                                            ></path>
                                        </g>
                                    </g>
                                    <g style="opacity: 0.1">
...
function renderFavorites(favorites) {
    document.getElementById('favoritesBoxesContainer').innerHTML = '';
...
document.addEventListener('click', (e) => {
    if (
        e.target.className == 'favoritesColorBoxes' ||
